...
import com.favour_food.app.ReusableCode.ReusableCodeForAll;
import com.favour_food.app.R;
...
public class Registeration extends AppCompatActivity {
    ...
    String[] Haryana = {"Ambala","Yamunanagar","Kurukshetra"};
    String[] Maharashtra = {"Mumbai", "Pune", "Aurangabad"};
    String[] Gujarat = {"Ahemdabad", "Rajkot", "Surat"};


    String[] Ambala = {"Amabala Cant","Amabala City","Mahash NAgar","Sahabad"};
    String[] Yamunanagar = {"Jagadhri","Pabni","Bilaspur","Sadhura"};
    String[] Kurukshetra ={"Joytisar","Thanasar","HudaColony","Sector17","Shanti Nagar"};
    String[] Mumbai = {"Marine Lines", "Charni Road", "Grant Road", "Mumbai Central", "Mahalakshmi", "Lower Parel", "Prabhadevi",
            "Dadar","Bandra", "Khar", "Santacruz","Ram Mandir", "Goregaon","Borivali", "MiraRoad","Naigaon", "Nalla Sopara", "Virar"};
           ...
           // Phone = (Button) findViewById(R.id.phone);
            ...
            City.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                ...
                public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    if (cityy.equals("Kurukshetra")) {
                        ArrayList<String> listt = new ArrayList<>();
                        for (String text : Kurukshetra) {
                            listt.add(text);
                        }
                        ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(Registeration.this, android.R.layout.simple_spinner_item, listt);
                        Suburban.setAdapter(arrayAdapter);
